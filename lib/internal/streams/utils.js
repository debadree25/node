...
const kIsDestroyed = SymbolFor('__PRIVATE__kIsDestroyed');
const kIsErrored = SymbolFor('__PRIVATE__kErrored');
const kIsReadable = SymbolFor('__PRIVATE__kReadable');
const kIsWritable = SymbolFor('__PRIVATE__kWritable');
const kIsDisturbed = SymbolFor('__PRIVATE__kDisturbed');
