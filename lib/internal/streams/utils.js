...
const kIsDestroyed = SymbolFor('nodejs.stream.kIsDestroyed');
const kIsErrored = SymbolFor('nodejs.stream.kErrored');
const kIsReadable = SymbolFor('nodejs.stream.kReadable');
const kIsWritable = SymbolFor('nodejs.stream.kWritable');
const kIsDisturbed = SymbolFor('nodejs.stream.kDisturbed');
