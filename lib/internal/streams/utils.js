...
const kIsDestroyed = SymbolFor('node.stream.__PRIVATE__kIsDestroyed');
const kIsErrored = SymbolFor('node.stream.__PRIVATE__kErrored');
const kIsReadable = SymbolFor('node.stream.__PRIVATE__kReadable');
const kIsWritable = SymbolFor('node.stream.__PRIVATE__kWritable');
const kIsDisturbed = SymbolFor('node.stream.__PRIVATE__kDisturbed');
