...
const kIsDestroyed = SymbolFor('nodejs.stream.isDestroyed');
const kIsErrored = SymbolFor('nodejs.stream.isErrored');
const kIsReadable = SymbolFor('nodejs.stream.isReadable');
const kIsWritable = SymbolFor('nodejs.stream.isWritable');
const kIsDisturbed = SymbolFor('nodejs.stream.isDistrurbed');
