...
const kIsDestroyed = SymbolFor('node.__PRIVATE__kIsDestroyed');
const kIsErrored = SymbolFor('node.__PRIVATE__kErrored');
const kIsReadable = SymbolFor('node.__PRIVATE__kReadable');
const kIsWritable = SymbolFor('node.__PRIVATE__kWritable');
const kIsDisturbed = SymbolFor('node.__PRIVATE__kDisturbed');
