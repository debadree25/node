...
const kIsDestroyed = SymbolFor('nodejs.stream.__PRIVATE__kIsDestroyed');
const kIsErrored = SymbolFor('nodejs.stream.__PRIVATE__kErrored');
const kIsReadable = SymbolFor('nodejs.stream.__PRIVATE__kReadable');
const kIsWritable = SymbolFor('nodejs.stream.__PRIVATE__kWritable');
const kIsDisturbed = SymbolFor('nodejs.stream.__PRIVATE__kDisturbed');
